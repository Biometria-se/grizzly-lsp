...
def test_setup_logging(mocker: MockerFixture) -> None:
    ...
    # <no args>
    args = Namespace(socket=False, verbose=False)
    ...
    # --socket
    args = Namespace(socket=True, verbose=False)
...
def test_main(mocker: MockerFixture) -> None:
    ...
    server_start_io_mock = mocker.patch('grizzly_ls.__main__.GrizzlyLanguageServer.start_io', return_value=None)
    server_start_tcp = mocker.patch('grizzly_ls.__main__.GrizzlyLanguageServer.start_tcp', return_value=None)
